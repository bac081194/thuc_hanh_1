...
*/
  ...
  chrome.cast.M = { AVAILABLE: "available", UNAVAILABLE: "unavailable" };
  x("chrome.cast.ReceiverAvailability", chrome.cast.M);
  chrome.cast.nb = { CHROME: "chrome", IOS: "ios", ANDROID: "android" };
  ...
  chrome.cast.Pa = { RUNNING: "running", STOPPED: "stopped", ERROR: "error" };
  x("chrome.cast.DialAppState", chrome.cast.Pa);
  chrome.cast.ib = { CAST: "cast", STOP: "stop" };
  ...
  function Oa() {
    return F()
      ? Na("Chromium")
      : ((E("Chrome") || E("CriOS")) && !(F() ? 0 : E("Edge"))) || E("Silk");
  }
  var Pa = {},
    G = function (a, b) {
  ...
  new G((q.trustedTypes && q.trustedTypes.emptyHTML) || "", Pa); /*
...
*/
  ...
  var Ua = function (a) {
      ...
      return a.replace(Ta, function (d, e) {
        ...
        if (!g) {
          ...
          g = (e = z) ? e.createHTML(g) : g;
          g = new G(g, Pa);
          if (
            1 === c.nodeType &&
            ((e = c.tagName), "SCRIPT" === e || "STYLE" === e)
          )
            throw Error(
              "SCRIPT" === e
          ...
          g instanceof G && g.constructor === G
            ? (g = g.g)
            : (za(
  ...
  chrome.cast.media.Ua = { SDR: "sdr", HDR: "hdr", DV: "dv" };
  ...
  chrome.cast.media.Wa = { MPEG2_TS: "mpeg2_ts", FMP4: "fmp4" };
  ...
  chrome.cast.media.T = { GENERIC_CONTAINER: 0, AUDIOBOOK_CONTAINER: 1 };
  ...
  chrome.cast.media.ya = { BUFFERED: "BUFFERED", LIVE: "LIVE", OTHER: "OTHER" };
  ...
  chrome.cast.media.wb = { TEXT: "TEXT", AUDIO: "AUDIO", VIDEO: "VIDEO" };
  ...
  chrome.cast.media.S = function (a) {
    this.containerType = a =
      void 0 === a ? chrome.cast.media.T.GENERIC_CONTAINER : a;
  ...
  chrome.cast.media.ea = function () {
    chrome.cast.media.MediaMetadata.call(
      this,
      chrome.cast.media.D.AUDIOBOOK_CHAPTER
    );
    this.images =
      this.subtitle =
      this.bookTitle =
  ...
  f.Qb = function (a, b, c) {
    H.m(
      this,
      "QUEUE_INSERT",
      new chrome.cast.media.ra([a]),
      b,
      c,
      chrome.cast.media.timeout.u
    );
  };
  f.bc = function (a, b, c) {
  ...
  f.Jb = function () {
    if (this.breakStatus && void 0 !== this.breakStatus.currentBreakTime)
      return this.playerState == chrome.cast.media.A.PLAYING && 0 <= this.g
  ...
  var Wa = function (a, b) {
    return Ba(a.items, function (c) {
      return c.itemId == b;
    });
  };
  x("chrome.cast.media.Media", chrome.cast.media.h);
  chrome.cast.media.h.prototype.removeUpdateListener =
    chrome.cast.media.h.prototype.aa;
  chrome.cast.media.h.prototype.addUpdateListener =
    chrome.cast.media.h.prototype.X;
  chrome.cast.media.h.prototype.getEstimatedLiveSeekableRange =
    chrome.cast.media.h.prototype.Kb;
  chrome.cast.media.h.prototype.getEstimatedBreakClipTime =
    chrome.cast.media.h.prototype.Ib;
  chrome.cast.media.h.prototype.getEstimatedBreakTime =
    chrome.cast.media.h.prototype.Jb;
  chrome.cast.media.h.prototype.getEstimatedTime =
    chrome.cast.media.h.prototype.Lb;
  chrome.cast.media.h.prototype.supportsCommand =
    chrome.cast.media.h.prototype.nc;
  chrome.cast.media.h.prototype.queueMoveItemToNewIndex =
    chrome.cast.media.h.prototype.Ub;
  chrome.cast.media.h.prototype.queueReorderItems =
    chrome.cast.media.h.prototype.Zb;
  chrome.cast.media.h.prototype.queueRemoveItem =
    chrome.cast.media.h.prototype.Xb;
  chrome.cast.media.h.prototype.queueRemoveItems =
    chrome.cast.media.h.prototype.Yb;
  chrome.cast.media.h.prototype.queueSetRepeatMode =
    chrome.cast.media.h.prototype.ac;
  chrome.cast.media.h.prototype.queueJumpToItem =
    chrome.cast.media.h.prototype.Sb;
  ...
  chrome.cast.media.h.prototype.queueUpdateItems =
    chrome.cast.media.h.prototype.bc;
  chrome.cast.media.h.prototype.queueAppendItem =
    chrome.cast.media.h.prototype.Qb;
  chrome.cast.media.h.prototype.queueInsertItems =
    chrome.cast.media.h.prototype.Rb;
  chrome.cast.media.h.prototype.editTracksInfo =
    chrome.cast.media.h.prototype.N;
  ...
  f.stop = function (a, b) {
    H.Ca(new Za(this.sessionId), a, b, chrome.cast.timeout.stopSession);
  };
  f.sendMessage = function (a, b, c, d) {
    H.hc(new Xa(this.sessionId, a, b), c, d);
  };
  f.X = function (a) {
  ...
  chrome.cast.j.prototype.getDialAppInfo =
    chrome.cast.j.prototype.getDialAppInfo;
  ...
  N.prototype.delete = function (a) {
    return P(this.i, a)
      ? (delete this.i[a],
        --this.size,
        this.l++,
        this.g.length > 2 * this.size && O(this),
        !0)
      : !1;
  };
  var O = function (a) {
  ...
  var mb = function (a, b, c, d, e, g, k, l, r, v) {
    ...
    nb = function (a) {
      var b = a.G.map(function (c) {
        ...
        null != a.C && e.set("launchTimeout", String(a.C));
  ...
  var ob = function () {
    ...
    qb = function (a, b) {
      ...
      if (a.playerState == chrome.cast.media.A.IDLE && null == a.loadingItemId)
        (a.currentItemId = null),
          (a.loadingItemId = null),
          (a.preloadedItemId = null),
          (a.items = null);
  ...
  var tb =
      E("Gecko") &&
      !(-1 != La().toLowerCase().indexOf("webkit") && !E("Edge")) &&
      !(E("Trident") || E("MSIE")) &&
      !E("Edge"),
    ub = -1 != La().toLowerCase().indexOf("webkit") && !E("Edge");
  !E("Android") || Oa();
  Oa();
  E("Safari") &&
    (Oa() ||
  ...
  var W = function () {
    ...
    zb = function (a) {
      var b = new chrome.cast.Error(
        chrome.cast.v.INVALID_PARAMETER,
    ...
    X = function (a, b, c, d) {
      ...
      c &&
        d &&
        (a = ib(a.R, b.sequenceNumber)) &&
        ((a = a.g),
        (d = new chrome.cast.Error(chrome.cast.v.INVALID_PARAMETER, d)),
        a && a(d));
    };
  W.prototype.initialize = function (a, b) {
    ...
    this.g = a;
    a.invisibleSender ||
      ((a = new PresentationRequest(Ab(this))),
      a.getAvailability().then(
        function (d) {
          d.onchange = function () {
            c.g.receiverListener(
              d.value ? chrome.cast.M.AVAILABLE : chrome.cast.M.UNAVAILABLE
            );
          };
          d.onchange();
        },
      ...
      (this.ha = (q.navigator || null).presentation.defaultRequest = a),
      a.reconnect(chrome.cast.Ga).then(
        function (d) {
          Y(c, d);
        },
        function () {}
          ...
          .catch(function (e) {
            ...
            e = new chrome.cast.Error(
              "AbortError" == e.name || "NotAllowedError" == e.name
                ? chrome.cast.v.CANCEL
                : chrome.cast.v.SESSION_ERROR
            );
            b && b(e);
          }));
  };
  var Ab = function (a, b) {
    ...
    var e = b.dialRequest;
    e &&
      ((c = e.appName), (d = e.launchParameter) && !d.match(Cb) && (d = xb(d)));
    var g = [];
    g.push({ appId: b.appId, capabilities: b.capabilities });
    b ||
      Aa(a.g.additionalSessionRequests, function (k) {
        g.push({ appId: k.appId, capabilities: k.capabilities });
      });
    return nb(
      new mb(
        g,
    ...
    a.Ca(
      ...
      function (l) {
        l.status && 1 == l.status.length
          ? e && e(l.status[0])
          : ((l = new chrome.cast.Error(chrome.cast.v.SESSION_ERROR)),
            g && g(l));
      },
      g,
      k
  ...
  f.setReceiverVolume = function (a, b, c, d) {
    ...
    X(
      this,
      new R("v2_message", b, void 0, chrome.cast.timeout.setReceiverVolume),
      new Q(this.i, c, d, chrome.cast.timeout.sendCustomMessage)
    );
  };
  f.getDialAppInfo = function (a, b) {
    X(
      ...
      new Q(this.i, a, b, chrome.cast.timeout.sendCustomMessage)
    );
  };
  f.ba = function (a) {
    var b = this;
    new PresentationRequest(Ab(this)).reconnect(chrome.cast.bb + a).then(
      function (c) {
        Y(b, c);
      },
      function () {}
  ...
  f.leaveSession = function (a, b, c) {
    X(
      this,
      new R("leave_session", a, void 0, chrome.cast.timeout.leaveSession),
      new Q(this.i, b, c, chrome.cast.timeout.leaveSession)
    );
  };
  f.hc = function (a, b, c) {
    X(
      this,
      new R("app_message", a, void 0, chrome.cast.timeout.sendCustomMessage),
      new Q(this.i, b, c, chrome.cast.timeout.sendCustomMessage)
    );
  };
  ...
  f.Ba = function (a) {
    if (a.l) {
      var b =
        a.playerState != chrome.cast.media.A.IDLE || null != a.loadingItemId;
  ...
  var Bb = function (a, b) {
    if (a.F) {
      ...
      pb(a.I, c, b) &&
        (a.s.delete(c), a.G.delete(c), (b = a.C.get(c))) &&
        (a.C.delete(c),
        J(b.o(), function (e) {
          e(d);
        }));
    ...
    switch (a.type) {
      ...
      case "v2_message":
        ...
        b &&
          "MEDIA_STATUS" == b.type &&
          b.status &&
          (b.status = b.status.map(this.La));
    }
    if ((b = ib(this.R, a.sequenceNumber)))
      "error" == a.type ? (b = b.g) && b(a.message) : (b = b.l) && b(a.message);
    if ((b = a.message))
      switch (a.type) {
  ...
  "complete" == document.readyState
    ? chrome.cast.da()
    : (window.addEventListener("load", chrome.cast.da, !1),
      window.addEventListener("DOMContentLoaded", chrome.cast.da, !1));
}.call(this));
